...
medical_words = ['medicine', 'hospital', 'bandages', 'etc']
rescue_words = ['rescue', 'stuck', 'flood', 'take', 'etc']
...
# isaid = "Im from vellore I'm happy"
...
for city in said_cities:
    # index of the city in the csv file data.csv
